const DetailsMarketingServices = () => {
  <>
          ...
          <div className="font-extrabold text-FFF6E4 text-left mr-20">
            ...
            <div className="w-60">
              <p className="text-base text-FFF6E4">
                Du SEO en passant par le Social Media Marketing profitez de nos
                services complémentaires. Boostez votre présence en ligne &
...
export default DetailsMarketingServices;
