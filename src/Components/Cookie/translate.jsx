const translations = {
  fr: {
    ...
    sans les accepter. Bon visionnage.",
  ...
  en: {
    ...
    cookieDescEn:
      "This website uses cookies to improve its functions and your experience. You may allow or disable cookies. Enjoy your visit.",
